...
4. Для оптимізації зображень використовуй сервіс [squoosh](https://squoosh.app/).
...
[Домашня робота № 2](https://github.com/acvetochka/goit-markup-hw-02) `поточний`
